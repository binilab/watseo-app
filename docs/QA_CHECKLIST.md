...
- [ ] QR 도착 확인에서 다른 장소의 QR 코드를 입력하면 “장소가 달라요” 안내가 보이고 다시 시도할 수 있다.
- [ ] QR 도착 확인에서 빈 코드나 잘못된 코드는 사용자용 안내만 보인다.
- [ ] QR 도착 확인에서 카메라 권한이 없어도 수동 입력을 계속 사용할 수 있다.
- [ ] 초대 코드 오류, 만료/사용 완료, 내 초대 수락 시 raw error 없이 쉬운 안내가 보인다.
- [ ] 장소 저장, 귀가 시작, 시간 연장, 도움 요청 실패 시 raw error 없이 다시 시도 안내가 보인다.
- [ ] 귀가 취소는 확인 팝업에서 “계속하기” 또는 “귀가 그만하기”를 선택한 뒤 실행된다.
- [ ] 목록/기록 불러오기 실패는 error 원문이 아니라 “정보를 불러오지 못했어요” 안내로 보인다.
